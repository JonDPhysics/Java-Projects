...
/**
 * Tests that the RobotFaceDrawer class has the drawCheckedLineStartsFilled method.
 * 
 * @author Chad Hogg
 */
public class Q04StructureTest {

	@Test
	public void testMethodExists() {
		Method[] methods = RobotFaceDrawer.class.getDeclaredMethods();
		String methodName = "drawCheckedLineStartsFilled";
